...
roverbaseboard: HAL_BOARD = HAL_BOARD_ROVERBASEBOARD
roverbaseboard: TOOLCHAIN = ARM
roverbaseboard: all
...
BOARDS = apm1 apm2 apm2beta apm1-1280 px4 px4-v1 px4-v2 sitl flymaple roverbaseboard linux
