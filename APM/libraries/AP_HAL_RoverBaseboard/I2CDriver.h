...
#ifndef __AP_HAL_ROVERBASEBOARD_I2CDRIVER_H__
#define __AP_HAL_ROVERBASEBOARD_I2CDRIVER_H__

#include <AP_HAL_RoverBaseboard.h>

class RoverBaseboard::RoverBaseboardI2CDriver : public AP_HAL::I2CDriver {
public:
    RoverBaseboardI2CDriver(AP_HAL::Semaphore* semaphore) : _semaphore(semaphore) {}
    void begin();
    void end();
...
#endif // __AP_HAL_ROVERBASEBOARD_I2CDRIVER_H__
